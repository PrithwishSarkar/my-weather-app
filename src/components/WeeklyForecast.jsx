...
export default function WeeklyForecast({ data }) {
    ...
    const [clicked, setClicked] = useState(false);//To determine whether to show graph or details
    ...
    }//Capitalizing first letter of weather consitions.
    ...
    );//Displaying weather forecast and temperature trends.
